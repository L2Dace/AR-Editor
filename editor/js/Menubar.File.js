...
function MenubarFile(editor) {
  ...
  option.onClick(function () {
    if (
      confirm(
        "Any unsaved data will be lost, and the Default Template will be loaded. Are you sure?"
      )
    ) {
      ...
      const markerPlaneGeometry = new THREE.PlaneGeometry(2, 2);

      // Load the image texture
      const markerTextureLoader = new THREE.TextureLoader();
      const markerTexture = markerTextureLoader.load(
        "files/markerForScale.png"
      );
      ...
      const defaultAmbientLight1 = new THREE.AmbientLight(0xcccccc, 0.25);
      //Name the light:
      ...
      editor.execute(new AddObjectCommand(editor, defaultAmbientLight1)); //bỏ command để add light at default
      ...
      editor.execute(new AddObjectCommand(editor, defaultAmbientLight2)); //bỏ command để add light at default
      ...
      const defaultDirectionalLight1 = new THREE.DirectionalLight(
        0xffffff,
        0.25
      );
      ...
      editor.execute(new AddObjectCommand(editor, defaultDirectionalLight1)); //bỏ command để add light at default
    }
  });
  options.add(option);
  ...
  option.onClick(async function () {
    ...
    const scriptDirectory = scriptSource.substring(
      0,
      scriptSource.lastIndexOf("/")
    );
  ...
  // Publish Share link and marker
  option = new UIRow();
  option.setClass("option");
  option.setTextContent(strings.getKey("menubar/file/share"));
  option.onClick(function () {
    //execute share link
  });
  options.add(option);
  ...
  option.onClick(function () {
    ...
    const appTitle = config.getKey("project/title") || "ARWebApp";
    ...
    function createZip(filesToFetch) {
      if (!Array.isArray(filesToFetch) || filesToFetch.length === 0) {
        return Promise.reject(
          new Error(
            "Invalid filesToFetch parameter. It should be a non-empty array."
          )
        );
      }
      ...
      return fetchFiles(filesToFetch)
        .then(function (dataArray) {
          dataArray.forEach(function (file) {
            ...
            console.log(
              "directoryPath + file.name, file.data, { binary: typeof file.data !== 'string' }: "
            ); //Test code
            console.log(
              "directoryPath + file.name: " + directoryPath + file.name
            ); //Test code
...
*/
    ...
    var filesToFetch = [
      //{url: '../editor/files/exportFiles/index.html', name: 'index.html', path: ''}, //this file needs to be edited before it's added in
      {
        ...
        name: "largeLambda.patt",
        path: "data/",
      },
      {
        url: "../editor/files/exportFiles/data/camera_para.dat",
        name: "camera_para.dat",
        path: "data/",
      },
      {
        url: "../editor/files/exportFiles/img/favicon.ico",
        name: "favicon.ico",
        path: "img/",
      },
      {
        url: "../editor/files/exportFiles/js/APP.js",
        name: "APP.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/GLTFLoader.js",
        name: "GLTFLoader.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/LegacyJSONLoader.js",
        name: "LegacyJSONLoader.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/OrbitControls.js",
        name: "OrbitControls.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/VRButton.js",
        name: "VRButton.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/ar-threex.js",
        name: "ar-threex.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/ar.js",
        name: "ar.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/es-module-shims.js",
        name: "es-module-shims.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/stats.min.js",
        name: "stats.min.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/three.js",
        name: "three.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/three.module.js",
        name: "three.module.js",
        path: "js/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/artoolkit.api.d.ts",
        name: "artoolkit.api.d.ts",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/artoolkit.api.js",
        name: "artoolkit.api.js",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/artoolkit.min.js",
        name: "artoolkit.min.js",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/artoolkit.three.d.ts",
        name: "artoolkit.three.d.ts",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/artoolkit.three.js",
        name: "artoolkit.three.js",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/artoolkit.worker.js",
        name: "artoolkit.worker.js",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/index.d.ts",
        name: "index.d.ts",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/jsartoolkit5/index.js",
        name: "index.js",
        path: "js/jsartoolkit5/",
      },
      {
        url: "../editor/files/exportFiles/js/data/camera_para.dat",
        name: "camera_para.dat",
        path: "js/data/",
      },
      {
        url: "../editor/files/exportFiles/js/data/lambda-old.patt",
        name: "lambda-old.patt",
        path: "js/data/",
      },
      {
        url: "../editor/files/exportFiles/js/data/lambda.patt",
        name: "lambda.patt",
        path: "js/data/",
      },
      {
