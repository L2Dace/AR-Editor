function Strings( config ) {
	...
	//This is where the menus display human-readable language
	//Can support multiple languages -- currently only supporting one since I can't read the others to change them.
	//commenting this out removes the text, but not the feature. That needs to be done at the resources level.
	...
	const values = {
		...
		en: {
			...
			'menubar/file': 'File',
			'menubar/file/new': 'New Default Template',
			'menubar/file/newBlank': 'New Blank',
			...
			'menubar/file/share':'Share Link & Marker',
